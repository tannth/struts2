...
<div class="inner-page-title">
	...
	<span>You can start building your next user interface with this
		powerful UI framework !</span>
...
<div class="content-box">
	...
	<div class="two-column">
		...
		<div class="column">
			...
			<div
				...
				<div class="portlet-header ui-widget-header">
					New Release: Admintasia 2.3<span
				...
				<div class="portlet-content">
					...
					<p>
						...
						<a href="http://www.admintasia.com"><b>Visit the
								presentation website</b></a> | <b> <a
							href="http://www.admintasia.com/live-demo"><b>View Live
									Demonstration</b></a></b> <br /> <br /> Prices start from <b>$50</b> for
						the <b>Regular License</b> and <b>$299</b> for the <b>Extended
							License</b>. Both licenses come with <b>support access</b> and <b>lifetime
							updates</b>.
		...
		<div class="column column-right">
			...
			<div
				...
				<div class="portlet-header ui-widget-header">
					Affiliate Program<span class="ui-icon ui-icon-circle-arrow-s"></span>
				</div>
				...
				<div class="portlet-content">
					...
					<p>
						Join our affiliates program and earn 51% of every sale. <br /> <br />
						<b><a href="http://www.admintasia.com/affiliates/">Click
								here for more details about our affiliates program</a></b>.
	...
	<div class="response-msg inf ui-corner-all">
		...
		<span>Multiple Themes</span> There are more themes available. To
		switch to another theme, click on its link from the sidebar menu.
	...
	<div class="three-col-mid three-col-mid2">
		...
		<div class="column col1">
			...
			<div class="content-box content-box-header ui-corner-all">
				...
				<div class="content-box-wrapper">
					...
					<a href="#" class="btn ui-state-default ui-corner-all"> <span
						class="ui-icon ui-icon-grip-dotted-horizontal"></span> Button 1

					</a> <a href="#" class="btn ui-state-default ui-corner-all"> <span
						class="ui-icon ui-icon ui-icon-gripsmall-diagonal-se"></span>

						Button 2

					</a> <a href="#" class="btn ui-state-default ui-corner-all"> <span
						class="ui-icon ui-icon-grip-solid-horizontal"></span> Button 3

					</a> <a href="#" class="btn ui-state-default ui-corner-all"> <span
						class="ui-icon ui-icon-grip-solid-vertical"></span> Button 3
					...
					<p>
						...
						<button
							class="ui-state-default float-left ui-corner-all ui-button"
							type="submit">Button Float Left</button>

						<button
							class="ui-state-default float-right ui-corner-all ui-button"
							type="submit">Button Float Right</button>
		...
		<div class="column col3">
			...
			<div class="content-box">
				...
				<h4 class="ui-box-header ui-corner-all">Simple Table (title
					with H4 tag)</h4>

				<p>This is a simple table, but there is also an advanced
					sortable table available.</p>
...
<div class="inner-page-title">
	...
	<span>Neque porro quisquam est qui dolorem ipsum quia dolor sit
		amet, consectetur, adipisci velit...</span>
...
<div id="dashboard-buttons">
	...
	<ul>
		...
		<li><a href="#" class="Briefcase_files tooltip"
			title="Briefcase files"> Briefcase files </a></li>

		<li><a href="#" class="Chart_4 tooltip" title="Chart 4">
		...
		<li><a href="#" class="Chart_5 tooltip" title="Chart 5">
		...
		<li><a href="#" class="Mail_open tooltip" title="Mail open">

				Mail open </a></li>

		<li><a href="#" class="Monitor tooltip" title="Monitor">
...
<div class="inner-page-title">
	...
	<span>The first example will show you a sortable portlets
		example</span>
	...
	<div class="three-col-mid">
		...
		<div class="column col1">
			...
			<div
				...
				<div class="portlet-header ui-widget-header">
					Feeds<span class="ui-icon ui-icon-circle-arrow-s"></span>
				</div>
			...
			<div
				...
				<div class="portlet-header ui-widget-header">
					News<span class="ui-icon ui-icon-circle-arrow-s"></span>
				</div>
		...
		<div class="column col2">
			...
			<div
				...
				<div class="portlet-header ui-widget-header">
					Shopping<span class="ui-icon ui-icon-circle-arrow-s"></span>
				</div>
		...
		<div class="column col3">
			...
			<div
				...
				<div class="portlet-header ui-widget-header">
					Links<span class="ui-icon ui-icon-circle-arrow-s"></span>
				</div>
...
<i class="note">To see more layout examples go to Layout Options
	Submenu from the main top navigation bar.</i>
...
<div class="content-box content-box-header ui-corner-all">
	...
	<div class="ui-state-default ui-corner-top ui-box-header">
		...
		<span class="ui-icon float-left ui-icon-signal"></span> Content box
		example title
